...
public class HoleESP extends Module {
    ...
    public HoleESP()
    {
        super("HoleESP", KEY_UNBOUND, Category.RENDER, "ESP for safe crystal holes",
                ...
                new SettingColor("Obsidian", 1f, 0.0f, 0.0f, false),
                new SettingColor("Bedrock", 1f, 0.0f, 0.0f, false));
    }
    ...
    public void drawFilledBlockBox(BlockPos blockPos, float r, float g, float b, float a)
    {
        ...
        float or = (float) (this.getSettings().get(3).asColor().getRGBFloat()[0] / 255.0D);
        float og = (float) (this.getSettings().get(3).asColor().getRGBFloat()[1] / 255.0D);
        float ob = (float) (this.getSettings().get(3).asColor().getRGBFloat()[2] / 255.0D);
        float br = (float) (this.getSettings().get(4).asColor().getRGBFloat()[0] / 255.0D);
        float bg = (float) (this.getSettings().get(4).asColor().getRGBFloat()[1] / 255.0D);
        float bb = (float) (this.getSettings().get(4).asColor().getRGBFloat()[2] / 255.0D);
