 ...
 */
package net.theairblow.lunarium.utils.file;
...
import net.theairblow.lunarium.setting.base.SettingBase;
...
public class BleachFileHelper {
	...
	public static void readFriends() {
		LunariumClient.friendMang = new FriendManager(BleachFileMang.readFileLines("friends.txt"));
	}
	...
	public static void saveFriends() {
		...
		String toWrite = "";
		for (String s : LunariumClient.friendMang.getFriends())
			toWrite += s + "\n";
