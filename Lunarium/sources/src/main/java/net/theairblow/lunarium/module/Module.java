 ...
 */
package net.theairblow.lunarium.module;
...
import net.theairblow.lunarium.setting.base.SettingBind;
...
public class Module {
	...
	public void onEnable() {
		...
		for (Method method : getClass().getMethods()) {
			if (method.isAnnotationPresent(Subscribe.class)) {
				LunariumClient.eventBus.register(this);
				break;
			}
		}
	}
	...
	public void onDisable() {
		...
		try {
			for (Method method : getClass().getMethods()) {
				if (method.isAnnotationPresent(Subscribe.class)) {
					LunariumClient.eventBus.unregister(this);
					break;
				}
			}
